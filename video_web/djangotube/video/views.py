...
def video_detail(request, pk):
    ...
    data = Video.objects.filter(id=pk)
    video_url = create_presigned_url('video-bucket-gtth1', str(data[0].Videofile))
    return render(request, 'video/video_detail.html', {'video':video, 'video_url':video_url,})
